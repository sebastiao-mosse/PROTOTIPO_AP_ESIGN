...
String token = JWT.create().
        ...
        .withExpiresAt(new Date(System.currentTimeMillis() +   Integer.parseInt(PropertiesCache.getInstance().getProperty("config.token_expiration"))))
        .sign(Algorithm.HMAC512(PropertiesCache.getInstance().getProperty("config.token_key")));
